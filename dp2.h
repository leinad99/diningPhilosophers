/**
 * Header file for dining philosophers part 2
 */
...
//array siginifying if the philosopher used the middle chopstick and for which chpstick he used it for
int usedMiddle[NUMBER];

//semaphore for the extra stick
sem_t extra_stick;
